...
const PlanningForm = () => {
  ...
  // Project options based on selected department
  const getProjectOptions = () => {
    ...
    return projectMap[selectedDepartment.value] || [];
  };
  ...
  const handleSubmit = (e) => {
    ...
    // Get available projects for the selected department
    const availableProjects = getProjectOptions();
    
    // Validate form - skip project validation if there are no projects for the department
    if (!selectedSector || !selectedDepartment || 
        (availableProjects.length > 0 && !selectedProject) || 
        !financialRequirement || !brief) {
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <Select
                ...
                styles={customSelectStyles}
                isSearchable
                placeholder={selectedDepartment && getProjectOptions().length === 0 ? "No projects available" : "Select Project"}
